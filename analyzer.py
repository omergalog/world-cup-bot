...
ב. ההבחנה המרכזית - סימני אזהרה לפייבוריטית:
   • פייבוריטית עם פער גדול ו**ללא** סימני אזהרה אמיתיים → סביר שתנצח, ולעיתים ברחב (גרמניה 7-1, שבדיה 5-1). אל תכווץ תוצאה מפחד.
   • פייבוריטית **עם** סימן אזהרה ממשי (כוכב מפתח פצוע/בספק, הגנה רעועה, הכנה כאוטית, רוטציה) מול יריבה מאורגנת → הסיכוי לתיקו/הפתעה גבוה משמעותית. שקול תיקו ברצינות (דוגמאות: ספרד בלי יאמל, אורוגוואי בלי 2 בלמים, איראן הכנה כאוטית, בלגיה הגנה רעועה - כולן תיקו).
