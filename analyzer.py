...
1. [ממוצע שערים + xG של {team1} + דירוג FIFA]
2. [ממוצע שערים + xG של {team2} + דירוג FIFA]
3. [פצועים/נעדרים חשובים + עוצמת ההרכב הצפוי]
4. [היסטוריית עימותים + פער האיכות בין הקבוצות]
5. [הגורם המכריע - אם יש פערי כוחות ברורים, ציין זאת]
