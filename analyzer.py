...
ב. עגן את ההכרעה להסתברות בפועל (Opta / שוק ההימורים) - זה העוגן הכי חשוב:
   ...
   הבחנה קריטית: ספרד 0-0 ואורוגוואי 1-1 היו פייבוריטיות של 87% ו-65% - אלה הפסדי **שונות** שאי אפשר היה לחזות, לא תיקו צפוי. לעומת זאת בלגיה-מצרים (37%/35%) היה קוין-פליפ אמיתי שבו תיקו מוצדק.
