...
עקרונות קריטיים (לקחים מטעויות עבר - חובה ליישם!):
א. תסמונת משחק פתיחה: פייבוריטיות מגמגמות במשחק הראשון בטורניר (לחץ, חוסר ריתמוס, יריבה ממוקדת-הגנה). אל תנפח את הפייבוריטית בפתיחה - שקול ברצינות תיקו או הפתעה.
ב. תמחר סימני אזהרה, אל תתעלם מהם: אם כוכב מפתח פצוע/בספק/ינוח - הורד משמעותית את הביטחון בקבוצה שלו, גם אם היא הפייבוריטית.
ג. אנדרדוגים מסוכנים: נבחרת חלשה עם מוטיבציה גבוהה, גוש הגנתי וקונטרות גונבת נקודות מהגדולות - במיוחד במשחקי פתיחה.
ד. xG ודירוג FIFA מתארים "מי טוב יותר", לא "מי ינצח היום". שליטה במשחק לא שווה שערים - קבוצה ששולטת אך לא מממשת עלולה לא לנצח.
ה. אם המשחק באמת צמוד או יש סימני אזהרה לשתי הקבוצות - אל תפחד לחזות תיקו. תיקו היא תחזית לגיטימית ולעיתים הנכונה ביותר.
